package digitalExamClock;

import digitalExamClock.appClasses.App_Controller;
import digitalExamClock.appClasses.App_Model;
import digitalExamClock.appClasses.App_View;
import digitalExamClock.splashScreen.Splash_Controller;
import digitalExamClock.splashScreen.Splash_Model;
import digitalExamClock.splashScreen.Splash_View;
...
public class ExamClock extends Application {
    private static ExamClock mainProgram; // singleton
    ...
    protected static ExamClock getMainProgram() {
        return mainProgram;
    }
}
